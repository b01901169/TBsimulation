...
%other
otherSpecialParamRuns = 1;  %default 0.  This section can be changed to whatever the particular run calls for.  At the very bottom.
...
if otherSpecialParamRuns == 1
    ...
    %uptakeUrbanKnowledge gives the probability of each age-sex group
    %knowing that TB treatment is available.  Rows are ages (given in
    %TBparams.uptakeUrbanKnowledge), and col 1 is males and col 2 is
    %females.
    TBparams.uptakeUrbanKnowledge = TBparams.uptakeUrbanKnowledge*1.2;  %increase knowledge of TB programs by 20%.
    
    %rerun the rural knowledge and category II treatment knowledge
    %parameters.
