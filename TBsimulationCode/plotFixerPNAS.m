...
markersize = 3;  %size of line markers, default is 6
...
axisfont = 'Arial'; %changes appearance of axis numbers
axisfontsize = 11.25;            %in points
axisfontweight = 'normal';    %options are 'light' 'normal' 'demi' 'bold' 
axisfontitalics = 'normal';   %options are 'normal' 'italic' 'oblique'

legendfont = 'Arial'; %changes text in the legend
legendfontsize = 11.25;
legendfontweight = 'normal';
legendfontitalics = 'normal';

labelfont = 'Arial';  %changes x, y, and z axis labels
labelfontsize = 11.49;  
labelfontweight = 'normal'; 
labelfontitalics = 'normal';

titlefont = 'Arial';  %changes title
titlefontsize = 12;
titlefontweight = 'normal';
titlefontitalics = 'normal';

textfont = 'Arial';   %changes text
textfontsize = 11.25;
