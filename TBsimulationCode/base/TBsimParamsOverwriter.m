...
TBMAC1a_increaseTrt = 0; %default 0, can be changed to 1
TBMAC1b_increaseTrt = 0;
TBMAC2a_initDefReduction = 0;  
TBMAC2b_trtSuccess = 0; 
TBMAC2c_MDRtrtSuccess = 0; %default 0, can be changed to 1.  for scenario 2a, only use the first.  For 2b, use one and two.  For 2c, use one and three.
TBMAC3_XpertReplacesSmear = 0;    
TBMAC3b_XpertReplacesSmear_SSsensUp = 0;  %scenario 3b is run with TBMAC3_XpertReplacesSmear = 0;
TBMAC4_activeCaseFinding = 0; %default 0, can be changed to 1
...
TBMAC2b_adv  = 0;
TBMAC2c_adv  = 0;
TBMAC3a_adv = 0;  %3a and 3b for adv is the same modification
Tbmac4_adv = 0;
...
if (TBMAC4_activeCaseFinding == 1 || TBMAC5_preventativeTherapyForLat == 1)
...
if Tbmac4_adv == 1
    ...
    TBmac4_sens = 0.90; TBmac4_spec = 0.9975; TBmac4_freq = 6; ACFpercOfUntrted = 0.3;
end
