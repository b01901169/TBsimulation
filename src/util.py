...
# ------------- copied from Bryan -------------
def single_infected_sim(n, T, G, S_safe, c, newE, newI, nu, mu, death_rate, alpha, single_beta, N_population, I_infected, E_latent, birth_rate):
    import numpy as np
...
if __name__ == "__main__":
    ...
    print "infected difference: {0}".format(total_infected_difference_list)
    print "population difference: {0}".format(total_population_difference_list)
